...
namespace AimsharpWow.Modules
{
    ...
    public class ClassicShadowboltWarlock : Rotation
    {
        ...
        {
            //Aimsharp.DebugMode();
            Aimsharp.PrintMessage("Classic Shadowbolt Warlock", Color.Purple);
        ...
        public override bool CombatTick()
        {
            ...
            if (Aimsharp.CanCast("Life Tap", "player"))
            {
                if (Mana < 400)
                {
